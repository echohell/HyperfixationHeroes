...
func set_skill_list(skill_list: Array):                                            # set skill list
	...
	pass
	# instead of get children, it should request what skills are currently active for the player
	# and then create buttons based on those currently available skills. if the player has no
	# current active skills, the special does nothing.
